...
export default function Hero() {
  ...
  return (
    <main
      ...
      style={{
        background:
          'linear-gradient(135deg, rgba(101, 92, 177, 0.08) 0%, rgba(101, 159, 207, 0.05) 50%, rgba(93, 214, 213, 0.08) 100%)',
      }}
    >
      {/* Background Decorative Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className="absolute -top-40 -right-40 w-80 h-80 rounded-full mix-blend-multiply filter blur-xl opacity-15 animate-blob"
          style={{ backgroundColor: '#655cb1' }}
        ></div>
        <div
          className="absolute -bottom-40 -left-40 w-80 h-80 rounded-full mix-blend-multiply filter blur-xl opacity-15 animate-blob animation-delay-2000"
          style={{ backgroundColor: '#659fcf' }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 rounded-full mix-blend-multiply filter blur-xl opacity-15 animate-blob animation-delay-4000"
          style={{ backgroundColor: '#5dd6d5' }}
        ></div>
      </div>
        ...
        <div className="text-center space-y-6">
          ...
          <div className="space-y-6 animate-fade-in-up">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-tight">
              ...
              <span className="relative inline-block">
                <span
                  ...
                  style={{
                    backgroundImage:
                      'linear-gradient(to right, #655cb1, #659fcf, #5dd6d5, #659fcf, #655cb1)',
                  }}
                >
                  Resultados Reais
                </span>
            ...
            <p className="max-w-3xl mx-auto text-xl sm:text-2xl text-gray-600 leading-relaxed font-light">
              Trabalhamos com{' '}
              <span className="font-semibold text-gray-600">marketing de performance</span> para
              acelerar o faturamento da sua clínica.
            </p>
          </div>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6 animate-fade-in-up animation-delay-200">
            <CTAButton utmContent="hero">
