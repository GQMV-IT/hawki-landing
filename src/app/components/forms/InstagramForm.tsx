...
export default function InstagramForm({ onSubmit, onBack, baseFormData }: InstagramFormProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const errorMessage = err instanceof Error ? err.message : 'Falha ao buscar perfil';
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {!userInfo ? (
                ...
                <>
                    {/* User Info Card */}
                    <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl p-6 border-2 border-[#659fcf]">
