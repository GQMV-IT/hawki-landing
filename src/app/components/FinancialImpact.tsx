        ...
        <div className="max-w-4xl mx-auto text-center space-y-10">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
              Leads desqualificados, baixa conversão e dependência de indicação estão custando 
              o crescimento da sua clínica. Com o Sistema de Captação Premium™, você elimina 
              esses vazamentos e transforma sua clínica em uma{' '}
              <span className="font-bold" style={{ color: '#655cb1' }}>
                máquina previsível de faturamento
              </span>.
            </p>
          </div>
          ...
          <div className="space-y-4 pt-4">
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900">
              Impressionado com o Sistema Completo?
            </h3>
            <p className="text-base sm:text-lg text-gray-600">
              Sim, quero descobrir como implementar isso na minha clínica
            </p>
